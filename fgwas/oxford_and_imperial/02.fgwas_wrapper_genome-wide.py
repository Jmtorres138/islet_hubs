...
home_dir = "/well/mccarthy/users/jason/projects/islet_hubs/fgwas/oxford_and_imperial/"
in_dir=home_dir+"fgwas_input/"
out_dir = home_dir + "fgwas_output/"
input_file=in_dir+"ukbb_diamante-euro.renamed.fgwas.gz" # Optional: Run 01.1 script and use this for abbreviated annotations: in_dir+"diagram_hrc.renamed.fgwas.gz"
...
def wrapper():
    ...
    while remaining > 0 and iter_count <= iter_limit:
        iter_count += 1
